...
class ClassifiedIntent(BaseModel):
    ...
    question: Optional[str] = Field(default=None, description="The raw conversational question/clarification text for EXPLAIN.")
...
- explain: Triggered when the user asks a conversational question, asks for explanation, or clarifies a concept or gap (e.g., "why did you flag that", "what's re-enrollment", "explain the second gap"). Put the query inside the `question` field.
